const ACTIVE_SLIDE_CLASSNAME = 'room__galery--active';

const slidesNodes = Array.from(document.querySelectorAll('.room__slide'));
console.log(slidesNodes);
const prevButtonNode = document.querySelector('.room__btn--prev');
const nextButtonNode = document.querySelector('.room__btn--next');
let activeId;
